    ...
    while total_timesteps < args.max_timesteps:
        ...
        for j in range(max_per_epi_steps):
            with torch.no_grad():
                ...
                state, reward, terminal, info = trainer.act(action, j, pre_state=state)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default='boatcong')  # boatcong, boatincong0, boatincong1
    parser.add_argument("--seed", default=1, type=int)  # Sets Gym, PyTorch and Numpy seeds
    parser.add_argument("--max_timesteps", default=50000, type=int)  # Max time steps to run environment for in buffer
    ...
    parser.add_argument("--mpc_horizon", default=5, type=int) # previous was 8
    ...
    parser.add_argument("--max_buffer_size", default=1e5, type=int)
    ...
    parser.add_argument('--save_dir', default="111717", type=str)
    parser.add_argument('--visualise', default=0, type=int)
    parser.add_argument("--save_points", default=1, type=int)
